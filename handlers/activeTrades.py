...
# Активные сделки
@dp.callback_query_handler(text=["activeTrades", "backActiveTrades"])
...
@dp.callback_query_handler(text=["nextBuy"])
...
@dp.callback_query_handler(text=["nextSell"])
...
# Отменить сделку
@dp.callback_query_handler(text=["cancelDeal"])
